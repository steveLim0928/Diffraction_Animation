...
4)  Once you selected your answer, you will straight away be directed
  to the next question.\n
5)  Once you selected your answer, you cannot go back to the previous
  question anymore.\n
6)  Once the time is up, the quiz will stop automatically.\n
7)  Any unanswered question will be considered as wrong.\n''',font = ('Bahnschrift SemiBold',15),bg = 'grey',justify= LEFT)
