...
frame1 = tk.Frame(root, width = 700, height = 500, bg = 'grey')
...
d= 180mm, n=1 and D= 5m, are substituted in order to find the
wavelength of the incident light.''',font =('Bahnschrift SemiBold',15,'bold'),fg='black',bg = 'grey',justify='left')
    text4.place(x=0, y = 300)
    #RADIOBUTTON
...
with zero amplitude. What is the phase difference between the two
waves?''',
                  font =('Bahnschrift SemiBold',15,'bold'),fg='darkblue',bg = 'grey',justify='left')
    text2.place(x =0, y = 65)
