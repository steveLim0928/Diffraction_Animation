...
def colour_screen (canvas2):
    SS_Colour_gradient.colour_6(canvas2)
...
#    canvas.create_text((20, 170), text = 'Light Generator', fill = 'black', angle = -90)
    ...
    # Window
    canvas.create_rectangle(20, 5, 40, 345, fill = colour, outline = 'black' )
    canvas.create_text((30, 170), text = 'L\nI\nG\nH\nT\n\nG\nE\nN\nE\nR\nA\nT\nO\nR', fill = 'white')
...
def indigo_scene_1(canvas, wavelength, colour, x):
    ...
    elif x <= (40 + (6 * wavelength)):
        canvas.create_rectangle(x, 90, x + 1, 250, fill = colour, outline = colour)
        canvas.create_rectangle(x - (wavelength - 1), 90, x - (wavelength - 2), 250, fill = colour, outline = colour)
        canvas.create_rectangle(x - ((2 * wavelength ) - 1), 90, x - ((2 * wavelength ) - 2), 250, fill = colour, outline = colour)
        canvas.create_rectangle(x - ((3 * wavelength ) - 1), 90, x - ((3 * wavelength ) - 2), 250, fill = colour, outline = colour)
        canvas.create_rectangle(x - ((4 * wavelength ) - 1), 90, x - ((4 * wavelength ) - 2), 250, fill = colour, outline = colour)
        canvas.create_rectangle(x - ((5 * wavelength ) - 1), 90, x - ((5 * wavelength ) - 2), 250, fill = colour, outline = colour)
...
def indigo_scene_2(canvas, colour, gap_size, a, screen_offset):
    global x1
    global x2
    global x3
    global x4
    ...
    if z2 >= 106.5  and z2 < 180 - (30 - screen_offset):
    ...
    if z12 >= 106.5  and z12 < 180 - (30 - screen_offset):
        diffracted_waves(canvas, colour, z12, gap_size, screen_offset)
        z12 += 0.5
    if z12 >= 180  - (30 - screen_offset):
        z12 += 0.5
    if z12 >= 221.5 + screen_offset:
        z12 = 106.5  + screen_offset
    ...
    if z14 >= 106.5  and z14 < 180 - (30 - screen_offset):
        diffracted_waves(canvas, colour, z14, gap_size, screen_offset)
        z14 += 0.5
    if z14 >= 180  - (30 - screen_offset):
        z14 += 0.5
    if z14 >= 221.5 + screen_offset:
        z14 = 106.5  + screen_offset
    ## --------------------------------------------------------------------------------------------
